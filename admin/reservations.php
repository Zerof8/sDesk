        ...
        if (isset($_SESSION['user'])) {
            ...
            if ($stmt_admin = mysqli_prepare($DBConnect, $query_admin)) {
                ...
                if (mysqli_stmt_num_rows($stmt_admin) !== 0) {
                    echo "<title>User Reservations Data</title>";
                } else {
            ...
            <main>
                ...
                <div id="news_box">
                    ...
                    if ($stmt = mysqli_prepare($DBConnect, $SQLstring)) {
                        ...
                        mysqli_stmt_bind_result($stmt, $id, $student_number, $room_number, $date, $time, $group_name);
                        ...
                        if (mysqli_stmt_num_rows($stmt) == 0) {
                            ...
                            echo "<tr><th>Reservation ID</th>
                             <th>Student Number</th><th>Room Number</th>
                             <th>Date</th>
                             <th>Time</th><th>Group Name</th>
                             <th>Action</th></tr>";
                            while (mysqli_stmt_fetch($stmt)) {
                                ...
                                echo "<td><a href='delete_reservation.php?reservationID=" . $id . "'>Delete</a></td></tr>";
                            }
                            echo "</table>";
                        }
